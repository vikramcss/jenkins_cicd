...
<div class="flex flex-col space-y-3 container lg:w-1/3 w-full mx-auto p-5 m-5 bg-gray-100 rounded shadow-xl">
	<div class="bg-orange-500 text-white font-semibold p-3 mb-3 rounded">Forgot Password</div>
	...
	<div class="flex justify-between pt-3">
		<button
			...
			class="text-center bg-white shadow-lg text-orange-500 hover:text-orange-700 font-bold py-2 px-4 rounded border-2 border-orange-500 hover:border-orange-700"
		>
			Go back
		</button>
		<button
