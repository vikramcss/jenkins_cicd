<script>
  ...
  let inpuEssentialQalificationOther = {
    label: "Other Essential Qalification",
    value: "",
    validate: true,
    readonly: false,
    error: null,
    placeholderValue: "Type Other Essential Qalification",
    error_mt: false,
    paddingsize: 0,
    validator: {
      method: (value) => {
        inpuEssentialQalificationOther.error = null;
        if (value.length <= 3) {
          inpuEssentialQalificationOther.error =
            "Other Essential Qalification can not be empty";
          return false;
        }
        return true;
      },
      errormessage: "Other Essential Qalification can not be empty",
    },
  };
  ...
  let inputUniversityOther = {
    ...
    validator: {
      method: (value) => {
        inputUniversityOther.error = null;
        if (value.length <= 3) {
          inputUniversityOther.error = "University/institute can not be empty";
          return false;
        }
        return true;
      },
  ...
  let inputMarksTypeOther = {
    ...
    validator: {
      method: (value) => {
        return inputMarksTypeOther.find((o) => o == value);
      },
      errormessage: "Enter marks must",
    },
  };
  ...
  let inputCGPAOther = {
    ...
    validator: {
      method: (value) => {
        ...
        if (val > 100 || val < 0) {
          inputCGPAOther.error = "CGPA should be a number";
          return false;
        }
        return true;
      },
  ...
  const validate = () => {
    ...
    if (inputQualification.selected == "Graduation") {
      ...
      console.log(
        "value of graduationStream is:",
        inputGraduationStream.selected
      );
      if (inputGraduationStream.selected == "Other") {
        console.log("inputOther.value :", inputOther.value);
        if (!inputOther.validator.method(inputOther.value)) {
          console.log("Input other validation returned false:");
          valid = false;
        } else {
          console.log("Input other validation returned true:");
        }
      }
      if (!validateMarks()) {
        valid = false;
  ...
  function toggleModal({ op }) {
    ...
    if (inputQualification.selected == "Graduation") {
      ...
      dispatch("add", { essentialQualification });
    } else if (
      inputQualification.selected == "English Typing 40" ||
      inputQualification.selected == "Hindi Typing 30"
    ) {
      ...
      dispatch("add", { essentialQualification });
    } else if (inputQualification.selected == "Other Qalification") {
      let essentialQualification = {
        qualification: inpuEssentialQalificationOther.value,

        degree: inputUniversityOther.value,
        otherDegree: inputOther.value,
        university: inputUniversityOther.value,
        yearOfPassing: inputYearOfPassing.value,
        marksType: inputMarksType.value,
        evaluation: {},
      };
  ...
  >
    <div class="relative w-auto my-6 mx-auto flex justify-center">
      ...
      >
        ...
        >
          <h3 class="text-3xl font-semibold">Add Essential Qualification</h3>
        ...
        <div class="relative p-6">
          <div class="grid grid-cols-1 md:grid-cols-2  md:gap-3  ">
            ...
            {:else if inputQualification.selected == "English Typing 40" || inputQualification.selected == "Hindi Typing 30"}
              <DropDown
            ...
            {:else if inputQualification.selected == "Other Qalification"}
              <TextInput
                bind:label={inpuEssentialQalificationOther.label}
                bind:value={inpuEssentialQalificationOther.value}
                validate={inpuEssentialQalificationOther.validate}
                readonly={inpuEssentialQalificationOther.readonly}
                bind:error={inpuEssentialQalificationOther.error}
                placeholderValue={inpuEssentialQalificationOther.placeholderValue}
                error_mt={inpuEssentialQalificationOther.error_mt}
                bind:paddingsize={inpuEssentialQalificationOther.paddingsize}
                validator={inpuEssentialQalificationOther.validator}
              />

              <TextInput
                bind:label={inputUniversityOther.label}
                bind:value={inputUniversityOther.value}
                validate={inputUniversityOther.validate}
                readonly={inputUniversityOther.readonly}
                bind:error={inputUniversityOther.error}
                placeholderValue={inputUniversityOther.placeholderValue}
                error_mt={inputUniversityOther.error_mt}
                bind:paddingsize={inputUniversityOther.paddingsize}
                validator={inputUniversityOther.validator}
              />
              <TextInput
                bind:label={inputYearOfPassingOther.label}
                bind:value={inputYearOfPassingOther.value}
                validate={inputYearOfPassingOther.validate}
                readonly={inputYearOfPassingOther.readonly}
                bind:error={inputYearOfPassingOther.error}
                placeholderValue={inputYearOfPassingOther.placeholderValue}
                error_mt={inputYearOfPassingOther.error_mt}
                bind:paddingsize={inputYearOfPassingOther.paddingsize}
                validator={inputYearOfPassingOther.validator}
              />
              ...
              <div class="gap-2 col-span-1 md:col-span-2 ">
                {#if inputMarksTypeOther.value === "Percentage"}
                  <div class=" md:flex justify-between  md:gap-2">
                    <TextInput
                      bind:label={inputMarksOther.label}
                      bind:value={inputMarksOther.value}
                      validate={inputMarksOther.validate}
                      readonly={inputMarksOther.readonly}
                      bind:error={inputMarksOther.error}
                      placeholderValue={inputMarksOther.placeholderValue}
                      error_mt={inputMarksOther.error_mt}
                      bind:paddingsize={inputMarksOther.paddingsize}
                      validator={inputMarksOther.validator}
                    />
                    <TextInput
                      bind:label={inputPercentageOther.label}
                      bind:value={inputPercentageOther.value}
                      validate={inputPercentageOther.validate}
                      readonly={inputPercentageOther.readonly}
                      bind:error={inputPercentageOther.error}
                      placeholderValue={inputPercentageOther.placeholderValue}
                      error_mt={inputPercentageOther.error_mt}
                      bind:paddingsize={inputPercentageOther.paddingsize}
                      validator={inputPercentageOther.validator}
                    />
                  </div>
                {:else}
                  <div class="flex justify-between ">
