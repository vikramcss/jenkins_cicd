<script>
  ...
  // let inputDateOfIssue = {
  //   label: "Date Of Issue",
  //   value: "",
  //   validate: true,
  //   readonly: false,
  //   error: null,
  //   placeholderValue: "Date Of Issue",
  //   error_mt: false,
  //   paddingsize: 0,
  //   validator: {
  //     method: (value) => {
  //       inputDateOfIssue.error = null;
  //       if (value.length < 2) {
  //         inputDateOfIssue.error = "Date Of Issue can not be empty";
  //         return false;
  //       }
  //       return true;
  //     },
  //     errormessage: "DOI Of Issue can not be empty",
  //   },
  // };
  let inputValidTill = {
    label: "Valid Till",
  ...
  function onAdd() {
    console.log("onAdd called 1");
    if (!validateInput()) {
      return false;
    }
    console.log("onAdd called 2");
