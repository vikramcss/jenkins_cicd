      ...
      >
        ...
        <div class="relative p-6">
          <div class="grid grid-cols-1 md:grid-cols-2  md:gap-3 ">
            ...
            {#if inputQualification.value == "10th"}
              <TextInput
                label={inputBoardName.label}
                value={inputBoardName.value}
                validate={false}
                readonly={true}
                paddingsize={inputSchoolName.paddingsize}
              /> <TextInput
            ...
            {:else}
            <TextInput
                label={inputDLNumber.label}
                value={inputDLNumber.value}
                validate={false}
                readonly={true}
                paddingsize={inputDLNumber.paddingsize}
              />
              <TextInput
                label={inputValidTill.label}
                value={inputValidTill.value}
                validate={false}
                readonly={true}
                paddingsize={inputValidTill.paddingsize}
              />
            {/if}
