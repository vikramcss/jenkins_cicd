  ...
  let inputTitle = {
    ...
    validator: {
      method: (value) => {
        ...
        if (value.length <= 3) {
          inputTitle.error = "Author should be at least 3 chars long";
          return false;
        }
        return true;
      },
  ...
  let inputNameOfJournal = {
    ...
    validator: {
      method: (value) => {
        inputAuthor.error = null;
        if (value.length <= 3) {
          inputAuthor.error = "Name of Journal should be at least 3 chars long";
          return false;
        }
        return true;
      },
  ...
  let inputPages = {
    ...
    validator: {
      method: (value) => {
        ...
        if (value.length <= 1) {
          inputPages.error = "Pages should be at least 1 chars long";
          return false;
        }
        return true;
      },
      errormessage: "Pages should be at least 1 chars long",
    },
  };
